    ...
    >
      <div className="col-span-2 order-1">
        <img
          ...
          className="lg:h-[420px] w-full rounded lg:rounded-tr-full lg:rounded-br-xl border-2 lg:border border-secondary brightness-75 p-4"
          title=""
        />
      </div>
      <div className="col-span-2 flex flex-col lg:order-1 gap-2">
        <Text
          subtitle="Events"
