...
export default function Footer() {
  return (
    <div className="lg:py-12 lg:mt-28 lg:px-20 p-4 mt-12 bg-dark grid gap-4 lg:grid-cols-2">
      ...
      <p className="lg:hidden flex font-header text-sm text-slate-300 mt-2 lg:text-text gap-2">
        All rights reserved
        <a
          href="mailto:abraralrawi997@gmail.com"
          className="flex text-secondary"
